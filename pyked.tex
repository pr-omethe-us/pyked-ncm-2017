...
\emph{sharing} utilizing the formats is available in the literature. To the best
of our knowledge, the largest such such publicly available database is hosted by
...
2013~\autocite{Goteng:2013cf},\todo{a few more refs needed}{} CloudFlame serves
...
Therefore, we believe there is a need for an open, community focused and
...
the community are welcomed. All development occurs under the BSD
