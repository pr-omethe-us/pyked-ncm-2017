...
Instead, such data must typically be found in non- or under-documented, nonstandard
...
(In the worst cases, data is only available in figures---and in some cases not at all.)
...
PrIMe represented an admirable first attempt at standardization, but a number of limitations
...
Our motivations are similar to some of those of the PrIMe and ReSpecTh teams, although
