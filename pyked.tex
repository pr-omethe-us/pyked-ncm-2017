...
have been shown to be quite useful. For instance, Olm and colleagues used their
...
The \pybox|write_file()| method writes a new \ck{} YAML file based on
the class' instance attributes, while \pybox|convert_to_ReSpecTh()| converts the \pybox|ChemKED|
...
of a chemical kinetic model for \ce{H2}\slash {CO} combustion.
%
\begin{pythonbox}
