...
\begin{response}
    ...
    All the existing database have a similar requirement, where users submit
    ...
    Lastly, while we hope other researchers will contribute to this database (such that it becomes
    more of a community effort than our effort), there is no requirement for others to use our
    database to use ChemKED files or PyKED. Others are free to use the tools internally, or
    download\slash fork our database and build their own.
    %
\end{response}
