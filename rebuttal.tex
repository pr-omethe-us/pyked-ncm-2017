...
\begin{response}
    ...
    To clarify the meaning of ``open'' when used in our article, we have added a brief definition
    and link to the definition of open source, which comes from the Open Source Initiative.
\end{response}
...
\begin{reviewer}
    ...
    In my opinioo n the YAML format resembles the XML format strongly. XML format is human-readable,
...
\begin{response}
    %
    We have updated the text to incorporate the suggested change.
    %
\end{response}
